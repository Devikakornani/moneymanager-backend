...
import com.devika.moneymanager.dto.RecentTransactionDTO;
...
public class DashboardService {
    ...
    public Map<String,Object> getDashboardDate(){
        ...
        returnValue.put("totalBalance",
                incomeService.getTotalIncomeForCurrentUser().subtract(expenseService.getTotalExpenseForCurrentUser()));
